...
**Latest:** v2.1.0 · macOS 13+ (Apple Silicon) · ~2 MB · MIT

[Download v2.1.0](https://github.com/beniamincostas/claude-usage-tracker/releases/latest) · [Changelog](CHANGELOG.md)

## Install

1. Download `ClaudeUsageTracker-v2.1.0.dmg` from [the latest release](https://github.com/beniamincostas/claude-usage-tracker/releases/latest)
2. Open the DMG
